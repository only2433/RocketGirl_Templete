...
import com.littlefox.storybook.dialog.WriterDialog;
...
public class MainListActivity extends BaseActivity {
	...
	private WriterDialog mWriterDialog;
    ...
    private void showWriterDialog()
    {
    	Log.f("");
    	if(mWriterDialog != null)
    	{
    		mWriterDialog.dismiss();
    		mWriterDialog = null;
    	}
    	
    	if(Feature.IS_TABLET_MODE == true)
    	{
    		mWriterDialog = new WriterDialog(this, R.style.BackgroundDialog);
    	}
    	else
    	{
    		mWriterDialog = new WriterDialog(this, R.style.BackgroundDialog_Super);
    	}
    	mWriterDialog.show();
    }
	...
	private OnClickListener mMenuClickListener = new OnClickListener()
	{
		...
		public void onClick(View v)
		{
			...
			case R.id.menu_button_writer:
				...
				GoogleAnalyticsHelper.getInstance(MainListActivity.this).sendCurrentAppView(InformationTemplete.ANALYTICS_VIEW_MENU_AUTHOR);
