...
public class IntroActivity extends BaseActivity
{
	...
	{
		RelativeLayout.LayoutParams params = (LayoutParams) _SkipBaseLayout.getLayoutParams();
	...
	private void setRunningEndInformation(Object object)
	{
		...
		switch(mCurrentMessage)
		{
			case MESSAGE_INIT:
				...
				{
					mDownloadAsync = new DownloadAsync(this, mInitItemResult.vibrator.url, StorybookTempleteAPI.PATH_APP_ROOT+Common.FILE_VIBRATOR_INFORMATION, mVibratorDownloadListener);
