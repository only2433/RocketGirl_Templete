...
public class InformationTemplete
{
	...
	public static final String COLOR_THUMBNAIL_BACKGROUND 		= "#f8e772";
	public static final String COLOR_INTRODUCTION_BACKGROUND 	= "#00c2be";
	public static final String COLOR_DEVICE_CODE_TEXT			= "#8f8132";
	public static final String COLOR_INTRODUCTION_TEXT			= "#ffffff";
	
	/**
	 * 앱 이름
	 */
	public static final String APP_NAME = "RocketGirl";
	
	/**
	 * 어플리케이션의 패키지명 : 반드시 변경
	 */
	public static final String PACKAGE_NAME 				= "com.littlefox.storybook.rocketgirl";
	
	/**
	 * 영상이 저장될 위치 : 반드시 변경
	 */
	public static final String MP4_FILE_PATH 				= Environment.getExternalStorageDirectory() + File.separator + "Littlefox"+ File.separator+"Storybook"+File.separator+"RocketGirl"+File.separator;
	
	/**
	 * 로그 파일 저장 명  : 반드시 변경
	 */
	public static final String LOG_FILE						= "story_book_rocket_girl.txt";
	 ...
	 */
	public static final String APP_LINK = "https://play.google.com/store/apps/details?id=com.littlefox.storybook.rocketgirl";
	 ...
	 */
	public static final String HTTP_HEADER_APP_NAME = "LF_App_Storybook_Rocketgirl";
	
	/**
	 * Google Analytics : 등록하면 변경해야함
	 */
	public static final String GOOGLE_ANALYTICS_PROPERTY_ID = "UA-37277849-3";
	
	/**
	 * 하나 아이템의 SKU
	 */
	public static final String ONE_PAY_ITEM_SKU = "lf_iap_1_item";
	
	/**
	 * 전체 아이템의 SKU
	 */
	public static final String ALL_PAY_ITEM_SKU = "lf_iap_all_item";
	
	/**
	 * 결제 관련 IN APP BILLING KEY : 앱을 베타테스트로 Publish 한 후에 해당 어플리케이션 정보에서 Services & APIs 항목의  Licensing & IN-APP Billing 의 키를 복사하여 바꾼다.
	 */
	public static final String IN_APP_BILLING_KEY = "";
	 ...
	 * 서버 어플리케이션의 서버키 
	 */
	public static final String SERVER_KEY = "AIzaSyAsXgSwFAppIjFuOpFEx6Z8JUzt9HN91To";

	/**
	 * Google API Console 에 등록한 Project ID
	 */
	public static final String SENDER_ID = "242727943664";
	...
	public static final String ANALYTICS_VIEW_SHARED_FACEBOOK 				= "공유 하기 - 페이스북";
	public static final String ANALYTICS_VIEW_SHARED_KAKAOSTORY				= "공유 하기 - 카카오 스토리";
	...
	public static final String ANALYTICS_VIEW_MENU_AUTHOR 					= "작가 소개";
	...
	public static final int MAX_AVAILABLE_FOR_PULCHASE_STORY_SIZE = 50;
